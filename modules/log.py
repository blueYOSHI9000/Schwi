...
def reglog (text, level, *, client=False, discord_log=True, cli_log=True):
    """1:1 copy of the log() function except not async - no discord logging sicne that requires async
